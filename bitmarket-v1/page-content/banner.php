...
@media screen and (min-width: 0px) and (max-width: 800px) {
  ...
  <div id="full-width-slider" class="royalSlider heroSlider rsMinW">
    <div class="rsContent">
      <img class="rsImg" src="assets/images/bn1.jpg" alt="">
      ...
      <div class="infoBlock infoBlockLeftBlack rsABlock" data-fade-effect="" data-move-offset="10" data-move-effect="bottom" data-speed="200">
        <h4>Modanın Kalbi Burada Atıyor</h4>
        <p>İstediğiniz ürünü alabilir ve satabilirsiniz.</p>
      </div>
    </div>
    <div class="rsContent">
      <img class="rsImg" src="assets/images/bn2.jpg" alt="">
   ...
   <div class="rsContent">
      <img class="rsImg" src="assets/images/bn3.jpg" alt="">
