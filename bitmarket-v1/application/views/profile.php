...
<form action="<?php echo base_url('users/editProfile'); ?>" method="POST">
                        <div class="userleft">
                                ...
                                <br> Ad
                                <br>
                                <input type="text" id="firstname" name="firstname" value="<?php echo isset($profileData->firstname ) ? $profileData->firstname : ""; ?>">
                                <br> Soyad
                                <br>
                                <input type="text" id="surname" name="surname" value="<?php echo isset($profileData->surname ) ? $profileData->surname : ""; ?>">
                                <br> E-Posta
                                <br>
                                <input type="email" id="email" name="email" value="<?php echo isset($profileData->email ) ? $profileData->email : ""; ?>">
                                <br> Telefon
                                <br>
                                <input type="text" id="telNo" name="telNo" value="<?php echo isset($profileData->telNo ) ? $profileData->telNo : ""; ?>">
                        ...
                        <div class="userright">
                            <!--<h5>Username cannot be changed</h5>-->
                                Adres
                                <br>
                                <textarea rows="5" cols="50" id="address" name="address" type="text"><?php echo isset($profileData->address ) ? $profileData->address : ""; ?></textarea>
                                <br> Posta Kodu
                                <br>
                                <input type="text" id="city" name="city" value="<?php echo isset($profileData->city ) ? $profileData->city : ""; ?>">
                                <br> Şehir
                                <br>
                                <input type="text" id="country" name="country" value="<?php echo isset($profileData->country ) ? $profileData->country : ""; ?>">
                                <br> Ülke 
                                <br>
                                <input type="text" id="zipCode" name="zipCode" value="<?php echo isset($profileData->zipCode ) ? $profileData->zipCode : ""; ?>">
                                <br>
